...
class Fuel_2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btnCalcular2.setOnClickListener {
            ...
            val precioDiesel = precioDieselEdit2.text.toString().toDoubleOrNull() ?: 0.0
            val precioEcoPais = precioEcoPaisEdit2.text.toString().toDoubleOrNull() ?: 0.0
            val precioSuper = precioSuperEdit2.text.toString().toDoubleOrNull() ?: 0.0
    ...
    private fun showAboutDialog() {
        AlertDialog.Builder(this)
            ...
            .setNeutralButton("Más información") { _, _ ->
                // Acción para más información (puedes abrir un enlace o mostrar otro diálogo)
            }
            .show()
    }
